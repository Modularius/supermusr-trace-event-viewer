...
use crate::{
    ...
    tui::{Channels, ComponentStyle, FocusableComponent, InputComponent, ListBox, ParentalFocusComponent, TuiComponent, TuiComponentBuilder},
    Component
};
...
impl Results {
    ...
    pub(crate) fn select<'a>(&mut self, cache: &'a Cache) -> Option<(&'a DigitiserMetadata, &'a DigitiserTrace, Channel)> {
        self.list
            .get_index()
